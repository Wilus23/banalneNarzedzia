...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="converter-container" id="converter-container">
          ...
          <form id="converterForm">
            ...
            <div className="input-group">
              ...
              <select id="jednostkaZ" name="jednostkaZ" required>
            ...
            <div className="input-group">
              ...
              <select id="jednostkaDo" name="jednostkaDo" required>
                <option value="" disabled selected>Wybierz jednostkę</option>
                <option value="centymetry">Centymetry</option>
                <option value="decymetry">Decymetry</option>
                <option value="metry">Metry</option>
        ...
        <div className="currency-container" id="currency-container">
          ...
          <form id="currencyForm">
            ...
            <div className="input-group">
              ...
              <select id="walutaZ" name="walutaZ" required>
            ...
            <div className="input-group">
              ...
              <select id="walutaDo" name="walutaDo" required>
                <option value="" disabled selected>Wybierz walutę</option>
                <option value="PLN">PLN (zł)</option>
                <option value="GR">GR (gr)</option>
                <option value="USD">$ (dolar)</option>
      ...
      <style jsx global>{`
        /* Przeniesione style z <style> do styled-jsx global */
        body {
          margin: 0;
          padding: 0;
          background: black;
